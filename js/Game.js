class Game {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          this.handleCollisionWithObs(index);
  ...
  gameOver() {
    swal ({
      title: `Game Over!`,
      text: "Oops your a loser!",
      imageUrl: "https://i.pinimg.com/originals/7c/1d/59/7c1d59ebd145a93bdf6b84c77fedc74f.png",
      imageSize: "100x100",
